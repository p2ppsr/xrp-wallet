...
- The signer uses an explicit transaction-field allowlist, permits only `Flags: 0`, and rejects partial-payment flags, `DeliverMin`, memos, or any other field the app did not construct.
