...
9. Add the canonical DER signature as `TxnSignature`, binary-encode the transaction, verify it locally, and compute the XRPL transaction ID.
10. Submit the blob and wait for a validated `tesSUCCESS` result.
